...
RxDataの値は、18GHzおよび26GHzの受信電界強度の頻度分布をそれぞれ-3[dB]刻みで求めた。

\subsection{手順5}
頻度分布を足し合わせ、累積分布を作成した。

RxDataについては、最大値からの差分で累積分布を求めた。
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\linewidth]{./rx_dist_18_max.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\linewidth]{./rx_dist_26_max.png}
